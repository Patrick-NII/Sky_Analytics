...
def load_data_url():
    ...
    try:
        df_degrade = pd.read_csv(degrade_url)
        print(f"Données chargées depuis {degrade_url} pour la date {today}")
    except Exception as e:
